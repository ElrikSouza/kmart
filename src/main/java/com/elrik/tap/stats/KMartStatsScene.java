...
public class KMartStatsScene extends AuthenticatedScene {
	...
	public KMartStatsScene() {
		...
		this.totalProductValueLabel.setBounds(100, 50, 300, 24);
		this.totalProductValueLabelValue.setBounds(100, 84, 300, 20);
		...
		this.avgPurchaseCostLabel = new AppLabel(
				String.format("<html>Valor medio das compras<br>%.2f R$</html>", 100f), 16f);

		this.avgChangeLabel = new AppLabel(
				String.format("<html>Valor medio do troco<br>%.2f R$</html>", 100f), 16f);

		this.profitLabel.setBounds(450, 50, 300, 24);
		this.profitLabelValue.setBounds(450, 84, 300, 24);
